...
This github repository contains the neccesary data and script required to fully reproduce the contents of Curtis et al. 2026, "Environmental DNA removal is mediated by presence of decomposing leaf litter in streams." 
