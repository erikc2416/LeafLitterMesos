Submerged leaf litter colonization alters aquatic environmental DNA
removal in experimental mesocosms

AUTHOR NAMES: Erik M. Curtis<sup>\*</sup>†<sup>1</sup>, Jennifer L.
Tank\*<sup>1</sup>, Elise D. Snyder<sup>1</sup>, Pedro F.P.
Brandão-Dias††<sup>2</sup>, Kyle Bibby<sup>3</sup>, Arial J.
...
<erik.curtis@mail.utoronto.ca>, JLT: <jtank@nd.edu>, EDS:
<esnyder4@nd.edu>, GAL: <glambert@nd.edu>

<sup>2</sup>Department of BioSciences, Rice University, 6100 Main St,
Houston, TX 77005-1827 USA, PFPBD: <pb21@rice.edu>, SPE: <spe1@rice.edu>

<sup>3</sup>Department of Civil & Environmental Engineering & Earth
Science, University of Notre Dame, 156 Fitzpatrick Hall of Engineering,
Notre Dame, IN 46556 USA, KB: <kbibby@nd.edu>, DB: <dbolster@nd.edu> 

<sup>4</sup>Department of Biological Sciences, The University of
...
waters. Allochthonous organic matter inputs represent an important
seasonal change in stream ecosystems. In smaller, headwater streams,
leaf litter accumulation and decomposition modify biotic and abiotic
conditions that may influence eDNA removal. We conducted experimental
releases of Common Carp (*Cyprinus carpio*) and Steelhead Trout
(*Oncorhynchus mykiss*) eDNA in recirculating mesocosms to explore how
leaf litter density and decomposition stage might influence eDNA
removal. We found that leaf density had no significant effect on eDNA
removal rates, but removal rates for smaller eDNA particles (0.4 – 1.2
μm) were 74% higher in mesocosms with biofilm-colonized leaves relative
to those with “fresh” leaves (Tukey HSD, p &lt; 0.001). In contrast, we
found no significant difference in removal rates between colonized and
uncolonized leaves for larger eDNA particles (&gt;1.2 μm). Overall, eDNA
removal rates were higher for smaller eDNA particles, particularly in
the presence of biofilm-colonized leaves, implying a biological
mechanism for eDNA removal from the water column. These results suggest
that seasonal leaf litter can affect the fate of eDNA particles and may
assist in interpreting eDNA data in natural systems.

SYNOPSIS: The deposition of leaf litter in flowing water has potential
to modify eDNA fate and transport. This study compares eDNA removal
under differing quantities and conditions of submerged leaf litter using
recirculating mesocosms.
...
been explored. The potential for leaves and their decomposition to
...
biofilms, on the removal of aquatic eDNA. We addressed two main
questions: 1) *Does the addition of leaf litter lead to increased
removal of eDNA through physical mechanisms, biofilm activity, or some
combination of the two?* 2) *Does the effect of leaves on eDNA removal
vary for differently-sized eDNA particles?* We hypothesized that both
physical removal by leaves and trapping by biofilms would increase the
rate of eDNA removal, and that removal would be fastest at high leaf
...
To investigate the effect of leaf litter on eDNA removal, we performed
experimental eDNA releases using 24 recirculating stream mesocosms
located at the Notre Dame Experimental Mesocosm Facility (EMF). The EMF
mesocosms are arrayed in four rows of six fiberglass mesocosms each,
linked via a motorized shaft with six individual paddlewheels that push
the water in a circular path around each mesocosm, simulating the
natural flow of a stream (**Fig. 1A**). Our experimental design included
six different experimental treatments, each with four mesocosm
replicates: no leachate or litter (“Control”); leaf leachate only
(“DOC”); low density, uncolonized litter (“Low Leaves”); low density,
colonized litter (“Low Leaves + Biofilm”); high density, uncolonized
litter (“High Leaves”); and high-density, colonized litter (“High
Leaves + Biofilm”). For the controls, we included only groundwater such
that these mesocosms represented the removal of eDNA from degradation
alone. For the leaf leachate treatments, we added 53.2 mg/L of sugar
maple leaf leachate (Acer Saccharum Marshall) to each mesocosm prior to
our eDNA additions. In the four treatments where we added leaf litter,
we used two densities of leaves, low(51 g m<sup>-2</sup> ) versus high
(102 g m<sup>-2</sup>), and two stages of biofilm colonization,
colonized versus uncolonized. We randomly assigned the n=6 treatments to
the n=24 mesocosms, ensuring that each of the four rows contained one
replicate of each treatment.

In Fall 2021, we collected freshly-fallen sugar maple leaves, oven-dried
them at 56°C for at least 48 hrs, and separated them in netted bags each
containing 6 g of dry leaf mass. For the treatments with
biofilm-colonized leaves, we obtained a biofilm slurry from decomposing
leaves in a local stream (Juday Creek, 41°43'42.4"N, 86°15'48.3"W) by
gently rinsing decaying leaf material through a 1-mm sieve into a
bucket. We then added 1 L of biofilm slurry and 25 L of low-nutrient
groundwater into each of the designated mesocosms before placing the
treatment-specific leaf density into each mesocosm. For the “Low
Leaves + Biofilm” mesocosms, we placed three netted bags (18 g) into
each mesocosm, and for the “High Leaves + Biofilm” mesocosms, we used
six netted bags (36 g). We allowed these leaves to colonize with natural
biofilms for 18 days prior to the experimental eDNA releases. For the
remaining treatment mesocosms, we only added leaves to streams 48 hrs
prior to the eDNA releases. We added three netted bags (18 g) into the
...
for the experiments (**Fig. 1A**). First, we removed leaves from DOC
treatments, leaving only the DOC-rich water behind. Then, we drained the
water from the non-DOC mesocosms and cleaned them (rinsing with a mild
vinegar solution). We also removed leaves from bags across all
treatments, and secured the leaves to 15x15-cm clean, ceramic tiles (n=5
per mesocosm) using thin rubber bands (Fig. 1A). We note that DOC
treatment mesocosms did not receive their leaves back, and remained
leafless. For the control and DOC treatments, we also placed five empty
tiles into each mesocosm. Finally, regardless of treatment, we fully
covered the bottom of all mesocosms with an extra 10 smaller
(7.5x7.5-cm) tiles. For treatments other than DOC, we re-filled the
mesocosms with 21 L of low-nutrient groundwater, and for DOC mesocosms,
we only replenished evaporated water to the same total volume. During
both the colonization and preparatory period, we set mesocosms to
...
experimental timeline. (C) Depiction of sequential filtration process
using 1.2-μm and 0.4-μm polycarbonate membrane filters.

*2.2 Experimental eDNA Releases*

On the morning of the eDNA releases, we collected water from 1) a moat
containing Common Carp (*Cyprinus carpio*) at the Potawatomi Zoo (South
Bend, IN) and 2) a holding tank containing Steelhead Trout
(*Oncorhynchus mykiss*) at the Bodine State Fish Hatchery (Mishawaka,
IN), using a clean 2-L container to collect enough water to fill n=4
five-gallon buckets at each site. We promptly transported the buckets
back to the laboratory and placed them in a refrigerator at 4°C. Next,
we collected 200-mL water samples from each bucket of release solution
to assess the concentration of the eDNA source solution. We also
collected 200-mL water samples from each mesocosm to confirm the absence
of Carp and Steelhead eDNA. To begin the experimental eDNA releases, we
homogenized the water in buckets using aquarium mixers. Once mixed, we
poured 2 L of both Carp and Steelhead eDNA solution into each of the 24
mesocosms, marking the beginning of the release. We collected 200-mL
water samples from each mesocosm at 40 minutes, 6 hours, 18 hours, and
30 hours post-release (**Fig. 1B**). We immediately placed these water
samples into an ice-filled cooler, along with a 200-mL groundwater blank
...
Information**). We determined that the particle size distribution did
not differ among the four buckets of Carp release solution (Chi-square,
p=0.073). However, PSD differed among the four buckets of Steelhead
release solution (Chi-square, p&lt;0.001), but we accounted for the
potential differences in PSD in our study design; within a given
treatment, each of the four replicate mesocosms was spiked with release
solution from a different bucket, so that any variation in the initial
concentration of eDNA would be distributed across experimental units. We
also accounted for this difference with the inclusion of the
random-intercept component in our mixed-effects linear model for eDNA
removal.

*2.4 Environmental Data*

We also measured relevant physicochemical variables prior to, and
during, the eDNA release. We collected filtered water samples for
nitrate (NO<sub>3</sub><sup>-</sup>-N), ammonia
(NH<sub>4</sub><sup>+</sup>-N), soluble reactive phosphorus (SRP), and
DOC concentrations at the beginning and end of the release period. We
also recorded mesocosm water volume, water column turbidity,
temperature, and pH for each mesocosm for each time point. We measured
water velocity at 40 minutes and at 30 hours. To assess the metabolic
...
*3.1 Experimental eDNA Release*

We observed a measurable decrease in eDNA concentration in 23 of 24
experimental mesocosms during the experiment. For one DOC replicate (DOC
Mesocosm 3), we were unable to accurately assess eDNA concentration, and
therefore we excluded this mesocosm replicate from all analyses. We also
measured an eDNA concentration of 0 gene copies mL<sup>-1</sup> for the
1.2-μm filter at initial time point for one mesocosm (Low Leaves
Mesocosm 3), which we attributed to an error during DNA extraction, and
so we also excluded this replicate from further analysis. Occasionally,
we observed eDNA concentrations of 0 or concentrations below the LOD for
the ddPCR assay, typically later in the study period. These measurements
were excluded from further analysis to ensure accuracy when quantifying
the removal rates. We note that at 40 minutes, we observed higher
concentrations of Steelhead eDNA relative to Carp eDNA, consistent with
the relationship between the two release solutions (**Fig. S1, see
Supporting Information**).

Overall, the decrease in eDNA concentration in the 23 mesocosms was
consistent with first-order removal (**Fig. 3A, 3B**). The eDNA particle
size distribution at 40 minutes roughly approximated the PSD for the
source solution, with the 1.2-μm size accounting for &gt;50% of the
total eDNA for most mesocosms (**Fig. 2, Inset panels)**. Because the
removal rate was different between particle sizes (p &lt;0.001, **Table
S3, see Supporting Information**), we also observed that the relative
proportion of components changed over time in mesocosms (**Fig. 2, Inset
panels**). The proportion of 1.2-μm Carp eDNA decreased significantly
over time for all but the DOC treatment (beta linear regression, p &lt;
0.03). The proportion of 1.2-μm Steelhead eDNA increased significantly
...
plots represent the proportion of eDNA for each particle size.

*3.2 Model Fit and Removal Estimates*

To account for the hierarchical nature of our experiment with repeated
observations within mesocosms, we analyzed removal using a mixed-effects
linear model. We observed a robust fit in our response vs. predicted
graph with low heteroscedasticity of variance and a roughly Gaussian
distribution for the residuals for the n=340 observations, consistent
with the assumptions of linear models (**Fig. S2, see Supporting
Information**). Notably, the model fit indicated a strongly significant
interaction between the three experimental factors in our experiment
(Treatment, Particle Size, and Target Organism), indicating that trends
...
Mesocosms with high-density biofilm-colonized leaves had significantly
faster eDNA removal rates relative to the four non-biofilm treatments
(k=3.75<sup>-1</sup> vs. Other treatments, k&lt;2.72 d<sup>-1</sup>;
Tukey HSD, p&lt;0.01 for all comparisons, **Fig. 4A**). We observed the
same effect at the 0.4-μm size class for both densities (High
Leaves+Biofilm, k=4.27 d<sup>-1</sup>; Low Leaves+Biofilm, k=3.75
d<sup>-1</sup> vs. Other treatments, k&lt;2.70 d<sup>-1</sup>; Tukey
HSD, p&lt;0.01 for all comparisons, **Fig. 4B**). However, for the
1.2-μm size class, mesocosms with biofilm-colonized leaves had
comparable removal rates to the control (High Leaves+Biofilm, k=3.24
d<sup>-1</sup>; Low Leaves+Biofilm, k=3.04 d<sup>-1</sup> vs. No Leaves,
k=2.74 d<sup>-1</sup>, Tukey HSD, p&gt;0.36 for both comparisons, **Fig.
4B**), indicating that the association with biofilm colonization and
faster eDNA removal was best attributed to smaller eDNA particles. DOC
was associated with a significant decrease in removal rate only for the
1.2-μm particle size (k=1.59 d<sup>-1</sup> vs. k=2.77 d<sup>-1</sup>,
Tukey HSD, p&lt;0.001, **Fig. 4B**).

Across all treatments, we observed faster removal for the 0.4-μm
particle size relative to the 1.2-μm particle size (k=3.04
d<sup>-1</sup> vs. k=2.60 d<sup>-1</sup>, Tukey HSD, p&lt;0.001). In
particular, this effect was significant for the high-density biofilm
treatment (k=4.27 d<sup>-1</sup> vs. k=3.24 d<sup>-1</sup>, Tukey HSD,
p&lt;0.001), the low-density biofilm treatment (k=3.75 d<sup>-1</sup>
vs. k=3.04 d<sup>-1</sup>, Tukey HSD, p&lt;0.01), and the DOC treatment
(k=2.60 d<sup>-1</sup> vs. k=1.60 d<sup>-1</sup>, Tukey HSD,
p&lt;0.001).

Although total eDNA removal rates did not differ significantly between
species (2.80 d<sup>-1</sup> vs. 2.83 d<sup>-1</sup>, Tukey HSD,
p=0.83), for Steelhead eDNA specifically we observed significantly
faster removal at the smaller (0.4 μm) particle size relative to the
larger (1.2 μm) particle size (k=3.38 d<sup>-1</sup> vs. k=2.28
d<sup>-1</sup>, Tukey HSD, p&lt;0.001). In comparison, removal rates for
Carp were comparable between small and large eDNA sizes (k=2.70
d<sup>-1</sup> vs. k=2.91 d<sup>-1</sup>, Tukey HSD, p=0.67). This
difference may relate to the differences in the initial eDNA
concentration for each species, with the starting concentration for
Steelhead exceeding that for Carp (**Fig. S1, see Supporting
Information**). This effect is visible when examining estimates of eDNA
...
particle size alone, and (C) Treatment, particle size, and target
organism. Letters denote pairwise comparisons within each panel (Tukey
HSD) with different letters indicating a significant difference
(p&lt;0.05).

*3.4 Environmental Variables*

Average turbidity, DOC concentration, ammonium concentration
(NH<sub>4</sub><sup>+</sup>-N), and SRP concentration were higher for
the DOC treatment relative to the remaining treatments, and average
nitrate concentrations (NO<sub>3</sub><sup>-</sup>-N) were elevated for
the High Biofilm treatment relative to control (Tukey HSD, p&lt;0.01 for
all comparisons, **Table S4, see Supporting Information**). Respiration
was significantly higher within the water column for the DOC treatment
(Tukey HSD, p=0.01, **Fig. S5A**), but respiration rates of leaf biota
did not differ by treatment (ANOVA, p=0.06, **Fig. S5B**). Environmental
conditions in the mesocosms were not significantly correlated with eDNA
removal (k, in d<sup>-1</sup>), excluding nitrate concentration
(NO<sub>3</sub><sup>—</sup>N, in μg N L<sup>-1</sup>), which had a
negative correlation of -0.33 (Pearson correlation, p=0.001).
...
*4.1 eDNA Removal Dynamics varied with leaf litter quality*

We hypothesized that leaf litter would impact eDNA removal through both
physical and biological mechanisms. Surprisingly, we found that both
densities (51 and 102 g m<sup>-2</sup>) of uncolonized leaves did not
influence eDNA removal rates compared to the control; rather, the
...
elevated eDNA removal rates for the two biofilm treatments might be
...
natural streams could alter this effect. In particular, the
decomposition and conditioning process applied to the leaves in this
study only represented the microbial effects of decomposition, as the
...
We observed that, on average, the smaller eDNA particle size (0.4 μm)
was removed faster than the larger particle size (1.2 μm), and that the
biofilm effect on removal was particularly strong for the 0.4-μm
...
substrate interactions. Brandão-Dias et al. (2023b) also observed that
removal of the 0.2 and 1.0-μm particle sizes was more strongly
associated with biotic mechanisms, similar to the 0.4-μm particle size
here.

In combination, the results of this study indicate that the removal of
eDNA at smaller sizes tends to be elevated in the presence of biofilms.
However, since we have not yet sought to identify the composition of
eDNA for these sizes, our explanation for this result may rely on the
environmental context. In particular, the lack of a relationship between
microbial respiration and eDNA removal in this study indicates that
enzymatic activity might play a less important role in eDNA removal in
flowing water. Instead, a higher efficiency of sorption to biofilms
mediated by differences in charge or chemical components for smaller
eDNA particles, coupled with increased physical trapping due to
differences in mass or shape of the eDNA particle, might be a more
parsimonious explanation for enhanced eDNA removal by microbially
colonized leaves.

*4.3 Conclusions*

To our knowledge, no previous laboratory or field study has examined the
interaction between leaf litter decomposition and eDNA removal.
Integrating this important aspect of seasonality into the broader
understanding of controls on eDNA transport and removal provides
critical insight into the use of eDNA-based species detection, and will
improve eDNA monitoring and interpretation when sampling forested
streams and rivers. In this study, we found that eDNA removal from the
water column increased in the presence of biofilm-colonized leaves,
particularly for smaller eDNA particles, but that removal rates were not
influenced by leaf quantity at the two levels tested here. We also
observed that eDNA particle size influenced removal rates based on the
interaction between the target organism (Carp vs. Steelhead) and
particle size. Our study highlights the importance of understanding the
environmental context, both physical and biological, when applying eDNA
to assess biodiversity or survey for target organisms. To improve eDNA
as a management tool, more work is needed to understand the components
of particle size distribution, which will help us to better understand
the complexities of eDNA removal across the vast gradient of
environmental conditions present within the waters we seek to manage
with eDNA.

ASSOCIATED CONTENT

**Supporting Information**.  
Additional Figures and Tables: Scatterplots of PSD over time, model
summary table and diagnostic plots, examination of model fits,
visualization of initial eDNA concentration of source solution, eDNA
Assay Primers/Probes, raw and modelled eDNA removal rates, environmental
data (PDF)  
RMarkdown Synopsis: complete reproduction of all analyses performed for
...
We would like to thank Emma Thrift-Cahall, Ursula Mahl, Mitchell
Liddick, Kayle Lauck, and Emma Pierce for their assistance in collecting
and filtering water samples during the experiment. We also extend our
gratitude to Brett Peters for constructing and managing the mesocosms at
the EMF, and to Dave Meuninck from Bodine State Hatchery and Amanda
Brunson-Cruz from the Potawatomi Zoo for access to water from their
facilities for target eDNA. This study was supported through funding
